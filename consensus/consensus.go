...
type EngineWriter interface {
	...
	Initialize(config *chain.Config, chain ChainHeaderReader, header *types.Header,
		state *state.IntraBlockState, txs []types.Transaction, uncles []*types.Header, syscall SysCallCustom, firehoseContext *firehose.Context)
	...
	Finalize(config *chain.Config, header *types.Header, state *state.IntraBlockState,
		...
		chain ChainHeaderReader, syscall SystemCall, firehoseContext *firehose.Context,
	...
	FinalizeAndAssemble(config *chain.Config, header *types.Header, state *state.IntraBlockState,
		txs types.Transactions, uncles []*types.Header, receipts types.Receipts, withdrawals []*types.Withdrawal,
		chain ChainHeaderReader, syscall SystemCall, call Call, firehoseContext *firehose.Context,
