...
func address(t *testing.T, in string) libcommon.Address {
	t.Helper()
...
func hash(t *testing.T, in string) libcommon.Hash {
	t.Helper()

	return libcommon.HexToHash(in)
}
