...
func (st *StateTransition) TransitionDb(refunds bool, gasBailout bool) (*ExecutionResult, error) {
	...
	st.state.AddBalance(coinbase, amount, false, evmtypes.BalanceIncreaseRewardTransactionFee)
...
func (st *StateTransition) refundGas(refundQuotient uint64) {
	...
	st.state.AddBalance(st.msg.From(), remaining, false, evmtypes.BalanceIncreaseGasReturn)
