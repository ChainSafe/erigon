...
type (
	...
	TransferFunc func(IntraBlockState, common.Address, common.Address, *uint256.Int, bool, *firehose.Context)
...
type IntraBlockState interface {
	...
	SetState(common.Address, *common.Hash, uint256.Int, *firehose.Context)
	...
	Selfdestruct(common.Address, *firehose.Context) bool
